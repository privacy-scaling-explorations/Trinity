...
pub use two_pc::{int_to_bits, setup, SetupParams};
...
//                 {
//                     // Option 1: Panic with a clear message:
//                     panic!("Halo2 mode is not supported in WASM builds");

//                     // Option 2: Fallback to plain mode:
//                     // KZGType::Plain
//                 }
//             }
